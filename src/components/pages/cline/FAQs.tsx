...
const faqs = [
  {
    question: "何のサービスなのか？",
    answer:
      "Cline導入と運用サポートをワンストップで行うものです。HP制作会社に特化しています。",
  },
  {
    question: "どんないいことがあるのか？",
    answer:
      "Clineを徹底活用して高速開発できるようになります。",
  },
  {
    question: "誰がやってくれるのか？",
    answer:
      "Cline活用の専門チームが導入から運用まで支援。制作現場に合った設定を行います。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "HP制作会社に特化し、現場のワークフローへ的確にClineを組み込む点が強みです。",
  },
  {
    question: "セキュリティは？",
    answer:
      "モデルは大手クラウド提供で安全性を重視しています。",
  },
  {
    question: "価格の根拠は？",
    answer:
